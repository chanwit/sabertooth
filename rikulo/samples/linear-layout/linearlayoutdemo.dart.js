...
$$._NativeJsSendPort = {"":
 ...
 super: "_BaseSendPort",
 hashCode$0: function() {
  return this._receivePort.get$_lib7_id();
 },
 operator$eq$1: function(other) {
...
$$._JsSerializer = {"":
 ...
 visitNativeJsSendPort$1: function(port) {
  return ['sendport', $._globalState().get$currentManagerId(), port.get$_isolateId(), port.get$_receivePort().get$_lib7_id()];
 },
...
$$._OnDemandMap = {"":
 ...
 getValues$0: function() {
  var t1 = this._lib5_map;
  return !(t1 == null) ? t1.getValues$0() : $.CTC55;
 },
 getKeys$0: function() {
  var t1 = this._lib5_map;
  return !(t1 == null) ? t1.getKeys$0() : $.CTC55;
 },
 forEach$1: function(f) {
  var t1 = this._lib5_map;
...
$$.View = {"":
 ["_inDoc", "_hidden", "_layout", "_profile", "_height", "_width", "_lib2_top", "_left", "_node", "_style", "_classes", "_mntAttrs", "_dataAttrs!", "_evlInfo", "_childInfo?", "_virtIS=", "_prevSibling=", "_nextSibling=", "_lib2_parent!", "_lib2_uuid", "_id?"],
 super: "Object",
 toString$0: function() {
 ...
 _addToDoc$6: function(node, outer, inner, before, keepId, location$) {
  var t1 = outer === true;
  if (t1 && (keepId === true && $.isEmpty(node.get$id()) !== true)) this._lib2_uuid = node.get$id();
 ...
 get$uuid: function() {
  if (this._lib2_uuid == null) {
    var t1 = $.View__uuidNext;
    $.View__uuidNext = $.add(t1, 1);
    this._lib2_uuid = $.StringUtil_encodeId(t1, $.viewConfig.get$uuidPrefix());
  }
...
$$._EventListenerInfo = {"":
 ...
 add$2: function(type, listener) {
  var t1 = ({});
  if (listener == null) throw $.captureStackTrace($.CTC57);
...
$$.Section = {"":
 ["_fellows", "_inDoc", "_hidden", "_layout", "_profile", "_height", "_width", "_lib2_top", "_left", "_node", "_style", "_classes", "_mntAttrs", "_dataAttrs", "_evlInfo", "_childInfo", "_virtIS", "_prevSibling", "_nextSibling", "_lib2_parent", "_lib2_uuid", "_id"],
 super: "View",
 get$domTag_: function() {
  return 'section';
 },
...
$$.TextView = {"":
 ["_html", "_text", "_inDoc", "_hidden", "_layout", "_profile", "_height", "_width", "_lib2_top", "_left", "_node", "_style", "_classes", "_mntAttrs", "_dataAttrs", "_evlInfo", "_childInfo", "_virtIS", "_prevSibling", "_nextSibling", "_lib2_parent", "_lib2_uuid", "_id"],
 super: "View",
 toString$0: function() {
...
$$.LayoutDeclarationImpl = {"":
 ...
 set$align: function(value) {
  this.setProperty$2('align', value);
 },
 get$align: function() {
 ...
 set$anchorView: function(view) {
  ...
  if (t1) var av = '';
    ...
    if (view == null ? t3 == null : view === t3) av = 'parent';
      ...
      if (view == null ? t2 == null : view === t2) throw $.captureStackTrace($.CTC51);
...
$$.ViewIterator = {"":
 ["_lib4_index", "_lib4_next=", "_lib4_ready", "_currCtx", "_offsetRoot", "_allIds", "_posOffset", "_selectors", "_root"],
 super: "Object",
 ...
 _seekNext$0: function() {
  this._currCtx = this._lib4_index < 0 ? this._buildRootCtx$0() : this._buildNextCtx$0();
  while (true) {
  ...
  if (!(this._currCtx == null)) {
    this._lib4_index = this._lib4_index + 1;
    return this._currCtx.get$view();
  }
  return;
 },
 _loadNext$0: function() {
  if (this._lib4_ready === true) return;
  this._lib4_next = this._seekNext$0();
  this._lib4_ready = true;
 },
 hasNext$0: function() {
  this._loadNext$0();
  return !(this._lib4_next == null);
 },
 next$0: function() {
  if (this.hasNext$0() !== true) throw $.captureStackTrace($.NoMoreElementsException$());
  this._lib4_ready = false;
  return this._lib4_next;
 },
 _lib4_ready$1: function(arg0) { return this._lib4_ready.$call$1(arg0); },
...
$._ViewImpl_getDOMEventDispatcher = function(type) {
  if ($._ViewImpl__domEvtDisps == null) {
    ...
    for (var t1 = $.iterator($.CTC58); t1.hasNext$0() === true; ) {
      var t2 = t1.next$0();
...
$.AnchorRelation_position = function(view, x, y, location$) {
  if (location$ == null || $.isEmpty(location$) === true) {
    ...
    $.index($._anchorXHandlers(), $.index(handlers, 0)).$call$3(x, $.CTC60, view);
    $.index($._anchorYHandlers(), $.index(handlers, 1)).$call$3(y, $.CTC60, view);
  }
};
...
$.dynamicFunction = function(name$) {
  ...
  var methods = ({});
  var dartMethod = (Object.getPrototypeOf($.CTC62)[name$]);
...
$.LinearLayoutDemo$ = function() {
  var t1 = new $.LinearLayoutDemo(null, [], null, '');
  t1.Activity$0();
  return t1;
};
...
$.getFunctionForTypeNameOf = function() {
  ...
  if ($.contains$1(userAgent, $.CTC61) === true) return $.typeNameInChrome;
...
$.CSSStyleDeclarationImpl__check = function(propertyName) {
  if ($.CSSStyleDeclarationImpl__illnms == null) {
    ...
    for (var t1 = $.iterator($.CTC53); t1.hasNext$0() === true; ) {
      var t2 = t1.next$0();
  ...
  if ($.startsWith(propertyName, 'margin') === true) throw $.captureStackTrace($.CTC54);
};
...
$.CTC57 = new Isolate.$isolateProperties.UIException('listener required');
...
$.CTC62 = new Isolate.$isolateProperties.Object();
...
_ConsoleImpl.get$profile = function() { return new $.BoundClosure0(this, 'profile$1'); };
...
$.$defineNativeClass('HTMLImageElement', ["width=", "name=", "height=", "border!", "align="], {
...
$.$defineNativeClass('TreeWalker', [], {
 ...
 get$previousSibling: function() { return new $.BoundClosure(this, 'previousSibling$0'); },
 nextSibling$0: function() {
  return this.nextSibling();
 },
 get$nextSibling: function() { return new $.BoundClosure(this, 'nextSibling$0'); },
 lastChild$0: function() {
  return this.lastChild();
 },
 get$lastChild: function() { return new $.BoundClosure(this, 'lastChild$0'); },
 firstChild$0: function() {
  return this.firstChild();
 },
 get$firstChild: function() { return new $.BoundClosure(this, 'firstChild$0'); },
 filter$1: function(arg0) { return this.filter.$call$1(arg0); }
});
...
(function(){
  ...
  var v8/*class(_UIEventImpl)*/ = 'UIEvent|TouchEvent|TextEvent|SVGZoomEvent|MouseEvent|WheelEvent|WheelEvent|KeyboardEvent|CompositionEvent|TouchEvent|TextEvent|SVGZoomEvent|MouseEvent|WheelEvent|WheelEvent|KeyboardEvent|CompositionEvent';
